...
public abstract class Stk<E> {

 

	protected int limt;
	private ObjectABuf evcache;
	private int sizelimit = -1;
	protected int size = 0;
	private int pointer = -1;
	protected ArrayList<Object[]> stk = new ArrayList<Object[]>(10);
	protected Object[] cu;

	public Stk(int sizelimit, ObjectABuf abbf) {
		if (sizelimit > 0)
